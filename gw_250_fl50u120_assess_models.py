# gw_250_fl50u120_assess_models.py
...
def get_gw_250_42ch_model_list():
    model_parent_directory = r"D:\Users\mickey\Data\models\pyt\lfads\gw_250_fl50u120\lfads_ecog"
    model_re = "cenc[0-9]*_cont[0-9]*_fact[0-9]*_genc[0-9]*_gene[0-9]*_glat[0-9]*_nch41_seqlen[0-9]*_ulat[0-9]*_orion*"
...
if __name__ == "__main__":
    ...
    dataset_path = r"D:\Users\mickey\Data\datasets\ecog\goose_wireless\gw_250_fl50u120"
    decimation_factor = 5   # dangt thing's to big
        ...
        if dry_run:
            ...
            if run_analysis:
                ...
                analyze_LFADS_ecog_performance.analyze(model_dir_path, dataset_path, 
                    ar_model_path, hyperparameter_path,dec=decimation_factor)
                # except asdf:
