...
def get_gw_250_42ch_model_list():
    ...
    model_re = "cenc[0-9]*_cont[0-9]*_fact[0-9]*_genc[0-9]*_gene[0-9]*_glat[0-9]*_nch42_seqlen[0-9]*_ulat[0-9]*_orion-pred*"
            ...
            if run_analysis:
                try:
                    analyze_LFADS_ecog_performance.analyze(model_dir_path, dataset_path, 
                        ar_model_path, hyperparameter_path, pred=pred)
                except:
